...
export class HomePage {
    ...
    getData()
    {
        ...
        .subscribe((r:any)=>
        {
            ...
            if(this.karigar_detail.user_type!=4){
    ...
    scan()
    {
        ...
        if( this.karigar_detail.status !='Verified'){
            let alert = this.alertCtrl.create({
                ...
                subTitle:"Your current profile status is not  <strong>“Verified”</strong>. You only scan the coupon codes when your profile status is <strong class=Approved>“Verified”</strong>. To know more, you can call us at <a href=tel:1800 833 2424>1800 833 2424</a> or chat with us.",
                buttons: [
                    // {
                    //     text: 'Chat With Us',
                    //     handler: () => {
  ...
  goOnContact(){
    ...
    alert1(){
        let alert = this.alertCtrl.create({
            ...
            subTitle:"Your current profile status is not <strong class=Approved>“Verified”</strong>.To know more, you can call us at <a href=tel:1800 833 2424>1800 833 2424</a>.",
            buttons: [
                {
                    text: 'Okay',
                    handler: () => {
    ...
    // }
       ...
       else if(this.karigar_detail.user_type != '3'){
        this.navCtrl.push(RedeemTypePage,{'mode':'home',"balance_point":this.total_balance_point, "redeem_point":this.karigar_detail.redeem_balance, "Status":this.karigar_detail.status,'bank_name':this.karigar_detail.bank_name,'account_no':this.karigar_detail.account_no,'ifsc_code':this.karigar_detail.ifsc_code,'account_holder_name':this.karigar_detail.account_holder_name});
    ...
    share()
    {
        ...
        let image = "";
        let app_url = "https://play.google.com/store/apps/details?id=com.kscadled.app";
        
        this.socialSharing.share("Hey there join me (" + this.karigar_detail.full_name + "-" + this.karigar_detail.mobile_no + ") on Kcsad LED ,app. Enter my code *" + this.karigar_detail.referral_code + "* to earn points back in your wallet!", "Reffral", image, app_url)
        .then(resp=>{
